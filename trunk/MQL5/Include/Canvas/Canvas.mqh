...
//--- set base default colors
   m_default_colors[0]= XRGB(0,0,255);     // blue
   m_default_colors[1]= XRGB(255,0,0);     // red
   m_default_colors[2]= XRGB(0,128,0);     // green
   m_default_colors[3]= XRGB(255,242,0);   // yellow
   m_default_colors[4]= XRGB(255,0,128);   // pink
   m_default_colors[5]= XRGB(0,255,0);     // lime
   m_default_colors[6]= XRGB(185,0,61);    // crimson
   m_default_colors[7]= XRGB(0,183,239);   // sky blue
   m_default_colors[8]= XRGB(255,128,0);   // orange
  }
//+------------------------------------------------------------------+
//| Destructor                                                       |
//+------------------------------------------------------------------+
